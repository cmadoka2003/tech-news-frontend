...
export function useBookmark(props) {
    ...
    const handleClick = () => {
        ...
        fetch(`https://tech-news-backend-indol.vercel.app/users/canBookmarks/${user.token}`)
            .then(res => res.json())
            .then(data => {
...
export function useFetchArticles() {
    ...
    useEffect(() => {
        fetch(`https://tech-news-backend-indol.vercel.app/articles`)
            .then((res) => res.json())
            .then((ArticleData) => {
...
export function useLogin() {
    ...
    function handleClickUp() {
        ...
        fetch(`https://tech-news-backend-indol.vercel.app/users/signup`, {
            method: "POST",
...
export function useLogout() {
    ...
    function handleClickIn() {
        fetch(`https://tech-news-backend-indol.vercel.app/users/signin`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
